...
def main():
    ...
    train_dataset = ListDataset(root=args.root, dataset=args.dataset, split='train', split=args.data_split, 
                           transform=transform_train, out_size=out_size)
    valid_dataset = ListDataset(root=args.root, dataset=args.dataset, split='val', split=args.data_split, 
